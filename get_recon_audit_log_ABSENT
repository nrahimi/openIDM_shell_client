...
#Returns audit log for given recon id showing only ABSENT situation
...
./geturl.sh "http://$OPENIDM_SERVER:$OPENIDM_SERVER_PORT/openidm/audit/recon?_queryId=audit-by-recon-id-situation&situation=ABSENT&reconId=$1"
